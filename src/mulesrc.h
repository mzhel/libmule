...
#define MULE_SOURCE_STATE_CONNECTED                 2
#define MULE_SOURCE_STATE_CONNECT_FAILED            3
#define MULE_SOURCE_STATE_HELLO_SENT                4
#define MULE_SOURCE_STATE_HELLO_RECEIVED            5
#define MULE_SOURCE_STATE_HANDSHAKE_COMPLETED       6
#define MULE_SOURCE_STATE_FILE_INFO_REQUEST_SENT    7
#define MULE_SOURCE_STATE_FILE_INFO_ANSWER_RECEIVED 8
